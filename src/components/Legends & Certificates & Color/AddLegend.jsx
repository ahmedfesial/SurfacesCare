...
export default function AddLegend({ updateClient, setUpdateClient, clientId }) {
  let token = localStorage.getItem("userToken");
  const query = useQueryClient();

  // Add Legend
  function addLegend(formvalue) {
    ...
    axios
      .post(`${API_BASE_URL}legends/create`, formData, {
        headers: {
      ...
      .then(() => {
        ...
        query.invalidateQueries(["AllLegend"]);
      })
      .catch(() => {
        toast.error("Something went wrong while adding the Legend");
      });
  }

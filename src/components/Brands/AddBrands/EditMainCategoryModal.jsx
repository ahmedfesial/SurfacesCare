...
export default function EditMainCategoryModal({
  open,
  onOpenChange,
  mainCategory,
}) {
  ...
  function updateMainCategory(values) {
    ...
    axios
      .post(
        `${API_BASE_URL}main-categories/update/${mainCategory.id}`,
        formData,
        {
          headers: {
              ...
              <div className="space-y-4">
                ...
                <div className="w-full flex flex-col md:flex-row gap-4 items-center text-[#1243AF]">
                  <div className="flex flex-col w-full md:w-1/2">
                    <label htmlFor="edit_main_image_url">
                      {t("Brand.Cover")}
                    </label>
                  ...
                  <div className="flex flex-col w-full md:w-1/2 mt-22">
                    <label htmlFor="edit_main_color_code">
